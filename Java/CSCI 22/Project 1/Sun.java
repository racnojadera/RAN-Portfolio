/**
 * Draws the sun. Also implements the interface drawingobject.
 *
...
public class Sun implements DrawingObject
{
     ...
     */
    public Sun(double x, double y, double s, int r, int g, int b)
    {
        this.x = x;
        this.y = y;
        origX = x;
    ...
    public void draw(Graphics2D g2d)
    {
        ...
        Ellipse2D sunMain = new Ellipse2D.Double(x-(size*0.5), y-(size*0.5), size, size);
