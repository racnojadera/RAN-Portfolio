/**
 * Displays a shadow of the umbrella. Also implements the interface drawingobject.
 *
...
public class UmbrellaShadow implements DrawingObject //http://clipart-library.com/img/798772.jpg
{
    private double x, y, origX, origY, size, degrees;
    private Color color;

    /**
     * Constructor for objects of class UmbrellaShadow
     ...
     */
    public UmbrellaShadow(double x, double y, double s, int r, int g, int b)
    {
        this.x = x;
        this.y = y;
        origX = x;
    ...
    /**
     * Draws the shadow of the umbrella
     */
    public void draw(Graphics2D g2d)
    {
        g2d.rotate(Math.toRadians(degrees-90),x,y+size);
