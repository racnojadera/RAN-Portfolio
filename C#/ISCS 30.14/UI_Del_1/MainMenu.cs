...
public class MainMenu : MonoBehaviour
{
    ...
    {
        OptionsMenu.transform.position = new Vector3(FirstMenu.transform.position.x + 170.0f, FirstMenu.transform.position.y - 40.0f, FirstMenu.transform.position.z);
        MonstersMenu.transform.position = new Vector3(FirstMenu.transform.position.x + 170.0f, FirstMenu.transform.position.y - 40.0f, FirstMenu.transform.position.z);
        ItemsMenu.transform.position = new Vector3(FirstMenu.transform.position.x + 170.0f, FirstMenu.transform.position.y - 80.0f, FirstMenu.transform.position.z);
        AttackMenu.transform.position = new Vector3(FirstMenu.transform.position.x + 170.0f, FirstMenu.transform.position.y, FirstMenu.transform.position.z);
    }
